 ...
 */
export interface IDatasSideBarState {
 ...
 */
export default class DatasSideBar extends React.Component<IDatasSideBarProps, IDatasSideBarState> {
    public state: IDatasSideBarState = {
    ...
    public render() {
        return (
            <div className="datas-sidebar-nav">
                <AutoSizer>
                    {({ height, width }) => (
                        <List
                            ref={this.listRef}
    ...
    public componentDidUpdate(prevProps: IDatasSideBarProps) {
